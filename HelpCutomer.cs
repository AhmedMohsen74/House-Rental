...
{
    public partial class HelpCutomer : Form
    {
        public HelpCutomer()
        {
            InitializeComponent();
        ...
        private void HelpCutomer_Load(object sender, EventArgs e)
        {

        }

        private void HelpCutomer_FormClosing(object sender, FormClosingEventArgs e)//if the customer clicks on the closing form ,it will appear the message if he want to close or not
        {
